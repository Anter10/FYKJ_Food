...
/**
 * Created by guoyouchao on 16/7/13.
 */
public class GosFoodCell extends BaseAdapter {
    ...
    public GosFoodCell(Context context, List<Map<String, TableSingModel>> data){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null){
            ...
            //获得组件，实例化组件
            convertView=layoutInflater.inflate(R.layout.gosfoodsingle, null);
